...
static const struct guninfo { short sound, reloadsound, magsize, attackdelay, damage, spread, projspeed, part, kickamount, rays, range, hitpush, splash, ttl, burstlen, guided, sub; const char *name, *file; } guns[NUMGUNS] =
{
    ...
    { S_SHOTGUN2,  -1, 6, 900,  9, 200, 0,   0, 20, 12,1024, 200, 0, 0,    0, 0, 2, "*",         "shotgdefault" }, //shotgdefault
    { S_PULSERIFLE, -1, 30, 100,  15, 50,  0,   0, 7,  1, 1024, 150, 0, 0,    0, 0, 1,  "}",        "pulse_rifle"}, //chaing
    ...
    { S_SHOTGUNBURST,  -1, 6, 500,  9, 100, 0,   0, 10, 6, 1024, 200, 0, 0,    3, 0, 1, "*", "shotgdefault"}, //shotgdefault
    //{ S_SHOTGUN,   1000,  9, 220, 0,   0, 20, 12,1024, 200, 0, 0,    0, 0, 2, "Shotgun",         "shotgdefault" },
    { S_UZI,       -1, 30, 100,   9,  40,  0,   0, 3,  1, 1024, 150, 0, 0,    0, 0, 1, "&",  "pyccna_m4a1"},
    ...
    { S_PISTOL,    -1, 18, 100, 12, 20,  0,   0, 8,  1, 1024, 150, 0, 0,    0, 0, 1, "%",          "pyccna_fn57" },
